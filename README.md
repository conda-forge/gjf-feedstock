...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gjf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14553&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gjf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gjf` can be installed with:

```
conda install gjf
```

It is possible to list all of the versions of `gjf` available on your platform with:
